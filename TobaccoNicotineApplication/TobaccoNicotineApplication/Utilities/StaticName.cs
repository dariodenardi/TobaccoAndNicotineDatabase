...
namespace TobaccoNicotineApplication.Utilities
{
    ...
    {
        public static string ContinentCode()
        {
        ...
        public static string PmiCoding()
        {
            return "Pmi Coding";
        }

        public static string PhaseCode()
        {
            return "Phase Code";
        }
        ...
        public static string MeasurementUnitName()
        {
            return "Measurement Unit";
        }

        public static string VarLc()
        {
            return "Var Lc";
        }
        ...
        public static string DataUs()
        {
            return "Data Us";
        }

        public static string ExchangeRateUS()
        {
        ...
        public static string DataPmi()
        {
            return "Data Pmi";
        }

        public static string PmiNotes()
        {
            return "Pmi Notes";
        }
